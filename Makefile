...
XTENSA_TOOLS_ROOT ?= $(dir $(shell which xtensa-lx106-elf-gcc))
...
MODULES		= user user/driver user/driver/i2c lib lib/esphttpclient
...
LDFLAGS		= -nostdlib -Wl,--no-check-sections -u call_user_start -Wl,-static -lm
