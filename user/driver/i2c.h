...
#define I2C_SDA_MUX         PERIPHS_IO_MUX_GPIO0_U
#define I2C_SDA_FUNC        FUNC_GPIO0
#define I2C_SDA_PIN         0

#define I2C_SCK_MUX         PERIPHS_IO_MUX_GPIO2_U
#define I2C_SCK_FUNC        FUNC_GPIO2
#define I2C_SCK_PIN         2
